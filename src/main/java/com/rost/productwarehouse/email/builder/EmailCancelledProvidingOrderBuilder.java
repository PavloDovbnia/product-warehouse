...
@Component
public class EmailCancelledProvidingOrderBuilder extends BaseEmailBuilder {

    @Override
    public EmailSendingData.Type getEmailType() {
        return EmailSendingData.Type.CANCELLED_PROVIDING_ORDER;
    }

    @Override
    String readContentTemplate() throws Exception {
        return readTemplate("EmailCancelledProvidingOrderContent.html");
    }
